...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 h-16 bg-background/95 border-b border-border/40">
      ...
      <div
        className={`md:hidden border-t border-border/40 bg-background overflow-hidden transition-all duration-200 ease-out ${
